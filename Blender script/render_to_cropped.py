...
atlases = [
    ...
    },
    {
        "name": "enemies",
        "objects": [
            {"name": "creature", "render_zero": False, "frames": [0, 10, 20]},
            {"name": "creature_attack", "render_zero": False, "frames": [26, 31, 35]},
            {"name": "creature_die", "render_zero": False, "frames": [12, 18, 70]},
            {"name": "creature_hit", "render_zero": False, "frames": [27, 37, 57]}
        ],
        "output_path": output_path,
        "dungeon_depth": DUNGEON_DEPTH,
        "dungeon_width": DUNGEON_WIDTH,
    ...
    },
    {
        ...
        "objects": [
            ...
            {"name": "crate_open", "render_zero": False}
        ],
        "output_path": output_path,
        "dungeon_depth": DUNGEON_DEPTH,
        "dungeon_width": DUNGEON_WIDTH,
